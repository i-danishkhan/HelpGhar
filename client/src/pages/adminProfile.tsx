        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 mb-8 pb-6 border-b border-gray-100">
              ...
              <div className="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden shrink-0">
                <svg viewBox="0 0 96 96" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <ellipse cx="48" cy="82" rx="26" ry="20" fill="#ef4444" />
                  <ellipse cx="48" cy="100" rx="34" ry="22" fill="#9ca3af" />
                </svg>
              </div>
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Bilal Iqbal</h2>
                <p className="text-sm text-gray-500 mb-2">System Administrator</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
              ...
              <div className="border border-gray-200 rounded-xl p-5">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    { label: "Full Name:", value: "Bilal Iqbal" },
                    { label: "Email:", value: "bilal12@gmail.com" },
                    { label: "Phone Number:", value: "03357891234" },
                    { label: "CNIC / ID:", value: "42101-276069-9" },
              ...
              {/* Account Info */}
              <div className="border border-gray-200 rounded-xl p-5">
                <h3 className="text-lg font-bold text-gray-900 mb-5">Account Info</h3>
                <div className="flex flex-col gap-4">
                  {[
                    { label: "Username:", value: "Bilal777", bold: false },
                    { label: "Role:", value: "Admin", bold: true },
                    ...
                    >
                      <span className="text-gray-500">{label}</span>
                      <span className={`text-gray-800 ${bold ? "font-bold" : "font-medium"}`}>
                        {value}
                      </span>
                    </div>
                  ))}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              {/* Security Settings */}
              <div className="border border-gray-200 rounded-xl p-5">
                <h3 className="text-lg font-bold text-gray-900 mb-5">Security Settings</h3>
              ...
              {/* Account Section */}
              <div className="border border-gray-200 rounded-xl p-5">
                <h3 className="text-lg font-bold text-gray-900 mb-5">Account Section</h3>
                <div className="flex flex-col gap-3">
                  <div className="flex gap-3">
                    <button className="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-6 py-2 rounded-lg transition-all">
                      Edit
                    </button>
