        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-100">
              ...
              <button className="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold px-5 py-2.5 rounded-lg transition-all shrink-0">
                Hire Worker
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div className="border border-gray-200 rounded-xl p-5">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="border-b border-gray-100 pb-4">
                    <button className="flex items-center gap-3 text-sm text-gray-700 hover:text-gray-900 transition-all w-full text-left">
                      <RefreshCcw size={17} className="text-gray-500 shrink-0" />
                      Reset Credentials
                    </button>
                  </div>
