...
import signupPic from "/assets/login-pic.png";
  ...
  <div style={{
    ...
    <div style={{
      ...
      <p style={{ fontSize: "0.875rem", color: "#666", margin: "0 0 6px", lineHeight: 1.6 }}>
        Welcome to <strong style={{ color: "#10B981" }}>HelpGhar</strong>. Your account is all set.
      </p>
...
const SignUp: React.FC = () => {
  ...
  const responsiveStyles = `
    ...
    @media (max-width: 768px) {
      .signup-illustration { display: none !important; }
      .signup-card { max-width: 100% !important; width: 100% !important; }
    }
  `;
  ...
  return (
    <div style={{ height: "100vh", overflow: "hidden", display: "flex", flexDirection: "column", fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      ...
      {/* ── PAGE BODY ── */}
      <main style={{ flex: 1, background: "#c2f0dc", overflow: "hidden", display: "flex", alignItems: "center", padding: "30px 0" }}>
        <div style={{
          display: "flex", alignItems: "center", justifyContent: "center",
          ...
          <div className="signup-illustration">
            <img src={signupPic} alt="Sign up illustration" />
          </div>
          ...
          <div className="signup-card" style={{
            ...
            {errorMessage && (
              <div style={{
                ...
                {errorMessage}
                <button onClick={() => setErrorMessage("")} style={{ marginLeft: "auto", background: "none", border: "none", cursor: "pointer", color: "#f87171", display: "flex", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", margin: "14px 0 11px" }}>
              ...
              <span style={{ fontSize: "0.77rem", color: "#999", whiteSpace: "nowrap" }}>or sign up with</span>
              <div style={{ flex: 1, height: "1px", background: "#e0e0e0" }} />
            </div>
