              ...
              <button
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all w-full text-left ${
                  activeNav === label
                    ...
                    : "text-gray-400 hover:bg-gray-700 hover:text-[#E9FFF1]"
                }`}
              >
                <Icon size={16} />
                {label}
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="bg-##E9FFF1 rounded-2xl shadow-sm border border-gray-100 p-6 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-100">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-[#E9FFF1] text-sm font-semibold px-5 py-2 rounded-lg transition-all shrink-0">
                Display Gig
              </button>
            </div>
              ...
              <div className="border border-gray-200 rounded-xl p-5">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-##E9FFF1 shadow transition-transform ${
