...
export default function WorkerStatus() {
  ...
  const getStatusButton = (booking: Booking) => {
    if (booking.status === "Completed") {
      return (
        <button className="bg-green-500 text-white text-sm font-semibold px-6 py-2 rounded-full cursor-default">
          Completed
        </button>
      );
    }
    if (booking.status === "Cancelled") {
      return (
        <button className="bg-gray-400 text-white text-sm font-semibold px-6 py-2 rounded-full cursor-default">
          Cancelled
        </button>
      );
    }
    ...
    return (
      <button
        ...
        className="bg-red-500 hover:bg-red-600 text-white text-sm font-semibold px-6 py-2 rounded-full transition-all"
      >
        Cancel
      </button>
    );
              ...
              {bookings.map((booking) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 text-sm">
                    ...
                    <p className="text-gray-700">
                      <span className="font-bold">To:</span> {booking.to}
                    </p>
                    <p className="text-gray-700">
